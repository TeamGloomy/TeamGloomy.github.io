...
The BTT Octopus Pro v1.0 F429 Version STM32F407VGT6 based boards.
...
* 5 x 100R resistor
* jumpers or other ways of connecting to the BTT Octopus Pro v1.0 F429 Version

### Connecting the SBC to the BTT Octopus Pro v1.0 F429 Version
The pinout for the BTT Octopus Pro v1.0 F429 Version can be found [here](https://github.com/bigtreetech/BIGTREETECH-OCTOPUS-V1.0/blob/master/Hardware/BIGTREETECH%20Octopus%20-%20PIN.pdf){:target="_blank"} and the schematic for the Duet 3 for reference can be found [here](https://github.com/Duet3D/Duet3-Mainboard-6HC/blob/master/Duet3_Mainboard_v1.0/Duet3_MB_schematic_v1.0.pdf){:target="_blank"}. The raspberry pi GPIO pinout can be found [here](https://www.google.com/search?q=raspberry+pi+gpio+pinout&rlz=1C1CHBD_en-GBGB889GB889&sxsrf=ALeKk01CVlA8N_CGAQqQGp-7_N3pXiV0LA:1586203613303&source=lnms&tbm=isch&sa=X&ved=2ahUKEwid56X3zNToAhXSURUIHX3IAnkQ_AUoAXoECA0QAw&biw=1920&bih=937){:target="_blank"}. 
...
| SBC Pin       | BTT Octopus Pro v1.0 F429 Version Pin       | Resistor Value  |
| :-------------: |:-------------:| :---------------:|
| 23/BCM11/SPI0 Clk    | B.13 on WiFi        | 100R            |
| 21/BCM9/SPI0 Miso    | C.2 on WiFi         | 100R           |
| 19/BCM10/SPI0 Mosi   | C.3 on WiFi         | 100R             |
| 24/BCM8/SPIO CE0   | B.12 on WiFi         | 100R             |
| 22/BCM25  | D.10 on WiFi         | 100R             |
...
All the SD card on the BTT Octopus Pro v1.0 F429 Version needs is the board.txt file with the following contents.
