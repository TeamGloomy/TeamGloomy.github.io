...
summary: "How to connect the BTT Octopus Pro v1.1 to a CAN-FD Expansion board"
sidebar: mydoc_sidebar
permalink: btt_octopus_pro_1.1_h723_canfd.html
folder: mydoc
comments: false
toc: false
datatable: true
...
The BTT Octopus Pro v1.1 can be connected to any of the CAN-FD expansion boards produced by Duet3D (or cloned by Fysetc) as well as another STM32H743 or STM32H723 board running in expansion board mode. This includes, but is not limited to:
