---
title: Connecting a 12864 screen to an SKR3 H743 Version
tags: []
keywords: 
last_updated: 10/04/2024
summary: "How to connect a 12864 screen to an SKR3 H743 Version"
permalink: skr_3_h743_screen_12864.html
folder: mydoc
comments: false
toc: false
datatable: true
...
{% include custom/H7/12864/fysetc_mini_12.html %}

</div>

<div role="tabpanel" class="tab-pane" id="reprap" markdown="1">

{% include custom/H7/12864/reprap.html %}

</div>

<div role="tabpanel" class="tab-pane" id="fysetc21" markdown="1">

{% include custom/H7/12864/fysetc_mini_21.html %}

</div>

</div>

{% include custom/H7/12864/menu.html %}

{% include custom/H7/12864/troubleshooting.html %}

{% include custom/H7/12864/sdcard.html %}
