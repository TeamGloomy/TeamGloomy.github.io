---
title: SKR3 H743 Version CAN-FD Information in RRF 3.5.0 Onwards
tags: []
keywords: 
last_updated: 10/04/2024
summary: "How to connect the SKR3 H743 Version to a CAN-FD Expansion board"
sidebar: mydoc_sidebar
permalink: skr_3_h743_canfd_3_5.html
folder: mydoc
comments: false
toc: false
datatable: true
...
Using the Duet 3 1LC toolboard as example (and the image below), the red wire on the CAN-FD cable is the CAN-H wire and the black is the CAN-L wire. They should be connected to the middle two connections on the CAN-FD connector on the SKR3 H743 Version. CAN-H is connected to CAN-H and CAN-L is connected to CAN-L.  
Although the SKR3 H743 Version also provides ground and 24v on that same 6 pin JST connector, we recommend wiring the toolboard directly to the PSU.
