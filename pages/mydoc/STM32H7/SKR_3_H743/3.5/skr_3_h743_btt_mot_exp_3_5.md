---
title: Connecting a BTT-MOT-EXP to an SKR3 H743 in RRF 3.5.0 Onwards
tags: []
keywords: 
last_updated: 10/04/2024
summary: "How to connect a BTT-MOT-EXP to an SKR3 H743"
sidebar: mydoc_sidebar
permalink: skr_3_h743_btt_mot_exp_3_5.html
folder: mydoc
comments: false
toc: false
datatable: true
...
BigTreeTech released the [BTT-MOT-EXP](https://github.com/bigtreetech/BTT-Expansion-module/tree/master/BTT%20EXP-MOT). It is an adapter that would ordinarily allow 3 more extra drivers to be added to an SKR3 H743.  

## Connecting the boards

Connect two 10-pin IDC cables between EXP1 and EXP2 on the SKR3 H743 and EXP1 and EXP2 on the BTT EXP-MOT V1.0.  
...
## SKR3 H743 Board.txt configuration
...
For more information about setting up sensorless homing, please read [this](skr_3_h723_sensorless_3_5.html){:target="_blank"}.  
