...
{% if site.latestStableFirmwareSTM32H7 == site.latestBetaFirmwareSTM32H7 %}
* [RRF Bootloader]({{site.latestStableFirmwareSTM32H7}}/bootloader){:target="_blank"}
{% else %}
The latest stable firmware files can be found [here]({{site.latestStableFirmwareSTM32H7}}){:target="_blank"}  
And the latest unstable firmware files can be found [here]({{site.latestBetaFirmwareSTM32H7}}){:target="_blank"}
{% endif %}
