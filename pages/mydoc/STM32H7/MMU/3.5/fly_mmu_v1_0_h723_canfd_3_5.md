---
title: Fly-MMU V1.0 H723 CAN-FD Information in RRF 3.5.0 Onwards
tags: []
keywords: 
last_updated: 10/04/2024
summary: "How to connect the Fly-MMU V1.0 H723 to a CAN-FD Mainboard"
sidebar: mydoc_sidebar
permalink: fly_mmu_v1_0_h723_canfd_3_5.html
folder: mydoc
comments: false
toc: false
datatable: true
...
The Fly-MMU V1.0 H723 can be connected to any Duet 3 mainboards produced by Duet3D (or cloned by Fysetc) as well as another STM32H743 or STM32H723 board. This includes, but is not limited to:
...
Also ensure that the slider near the CAN port is set to `CAN` and not `RS232`.  
