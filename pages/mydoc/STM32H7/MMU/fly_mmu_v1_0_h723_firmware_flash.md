...
permalink: fly_mmu_v1_0_h723_firmware_flash.html
folder: mydoc
comments: false
toc: false
datatable: true
boardname: Fly-MMU V1.0
booturl1: "{{site.latestStableFirmwareSTM32H7}}"
...
{% capture bootloaderURL %} {{page.booturl1}}{{page.booturl2}} {% endcapture %}
...
Download either the Stable firmware file called `firmware_mmu_h723.bin` for 2209 drivers or `firmware_mmu5160_h723.bin` for 5160 drivers from [here]({{site.latestStableFirmwareSTM32H7}}/mainboard/fly) or the latest beta/RC firmware file called `firmware_mmu_h723.bin` for 2209 drivers or `firmware_mmu5160_h723.bin` for 5160 drivers from [here]({{site.latestBetaFirmwareSTM32H7}}/mainboard/fly).
...
The {{page.boardname}} can now be connected to an RRF mainboard. Please see the [CAN-FD Connection Page](fly_mmu_v1_0_h723_canfd.html).
