...
permalink: afc_lite_v1_0_h723_bootloader.html
folder: mydoc
comments: false
toc: false
datatable: true
...
As the board does not have an SD card socket, DFU will have to be used to initially flash the firmware. Subsequent updates can be done over CAN-FD. Following the [Firmware Flashing Instructions](afc_lite_v1_0_h723_firmware_flash.html).
