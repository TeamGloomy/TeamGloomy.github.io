...
permalink: afc_lite_v1_0_h723_firmware_flash.html
folder: mydoc
comments: false
toc: false
datatable: true
...
Download either the Stable firmware file called `firmware_afclite1_h723.bin` from [here]({{site.latestStableFirmwareSTM32H7}}/mainboard/ldo) or the latest beta/RC firmware file called `firmware_afclite1_h723.bin`  from [here]({{site.latestBetaFirmwareSTM32H7}}/mainboard/ldo).
...
The {{page.boardname}} can now be connected to an RRF mainboard. Please see the [CAN-FD Connection Page](afc_lite_v1_0_h723_canfd.html).
