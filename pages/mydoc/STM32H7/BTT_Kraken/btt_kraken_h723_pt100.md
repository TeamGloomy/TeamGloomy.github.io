...
The {{page.boardname}} has support for two x 2 wire and 4 wire PT100 and PT1000.  

## Board Setup

The {{page.boardname}} has a series of dip switches that must be set when using 2 and 4 wire PT100 and PT1000.  
