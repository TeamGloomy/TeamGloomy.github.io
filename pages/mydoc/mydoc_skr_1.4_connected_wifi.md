...
If you would prefer a PCB connected to the board, user PCR has created a wifi board for the SKR v1.4. It can be purchased on tindie [here](https://www.tindie.com/products/pcr/reprapfirmware-wifi-adapterboard-for-skr1314/) 
...
If using TMC22XX drivers (thats either the TMC2208, TMC2209, TMC225 or TMC2226), the following line must also be added to the board.txt file
```
