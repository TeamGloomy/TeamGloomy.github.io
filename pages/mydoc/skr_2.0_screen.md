...
summary: "Connecting a screen to a SKR v2.0"
...
Both serial screens (e.g. Fly Screens, BTT TFT, Paneldue) and 12864 displays (like the stock ender 3 screen) can be connected to an SKR v2.0.  
These instructions cover serial screens. Instructions for 12864 screens can be found [here](/skr_2.0_screen_12864.html).  
