---
title: Connecting an MKS SGen L v2.0 via an ESP8266 WiFi Adapter
tags: []
keywords: 
...
The table below shows the pins required on the ESP8266 and what they are connected to on the MKS SGen L v2.0. Please ensure that your cables are no longer than 30cm although they should ideally be as short as possible.  
