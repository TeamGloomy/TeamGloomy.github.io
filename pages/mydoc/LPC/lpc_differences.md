...
The CPUs targeted in this port only have 64K RAM which is less than those that run dc42's RepRapFirmware. Further, there are also some differences between the CPUs, and the following outlines the main differences in this port:  
...
* Configuration:
  * See [Driver Timings](driver_timings_lpc.html) for information about setting the correct timings.
  * See [Custom Commands and Gcode](custom_commands_gcode_lpc.html) for information about additional gcode and unsupported gcode.  
...
* TMC5160 drivers will not be supported on LPC based boards.
