...
permalink: updating_standalone_lpc.html
folder: mydoc
comments: false
toc: false
datatable: true
...
See [Getting Started](https://teamgloomy.github.io/getting_started_lpc.html#firmware) in case you need to install RRF from scratch. Since RRF usually does updates from a running system, this should only be necessary in rare cases.
