...
summary: "Connecting an vSKR 1.3 via SBC"
...
(The wiki used to have pin 0.28 for 22/BCM25. Either 0.28 or 1.31 can be used. 1.31 is now prefered as its on the same header as the other pins).
...
All the SD card on the SKR v1.3 or 1.4 needs is the board.txt file with the following contents. If using this with an SKR v1.3, change the lpc.board value to biquskr_1.3
...
Place the *board.txt* file in a directory called "sys" on the SD card and install the SD card in the SKR v1.3 or v1.4.   
