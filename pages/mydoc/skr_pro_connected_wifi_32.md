...
The SKR Pro v1.1 and v1.2 is an STM32F407ZGT6 based board.
...
* 1 x 36 pin ESP32
* 1 x 330R resistor
* jumpers or other ways of connecting to the SKR Pro v1.1 and v1.2
...
The table below shows the pins required on the ESP32 and what they are connected to on the SKR Pro v1.1 and v1.2. Please ensure that your cables are no longer than 30cm although they should ideally be as short as possible.  
...
```
//Config for SKR Pro v1.1 and v1.2
