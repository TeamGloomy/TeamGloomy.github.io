...
summary: "Connecting an accelerometer to a Fly-407ZG"
...
One possible method of connecting the accelerometer to the Fly-407ZG is described in the table below. The image can be used to aid in identification.  
...
|Accelerometer Image Wire Colour|Accelerometer Pin Name|Accelerometer Pin Type|Fly-407ZG Pin|Fly-407ZG Pin Name|
|:---|:---|:---|:---|:----|
|Red|VIN| +5v Input| +5v| -|
|Black|GND|Ground|GND|-|
|Yellow|SCL|SPI SCK|E.8||
|Green|SDA|SPI MOSI|E.7||
|Blue|SDO|SPI MISO|E.10||
|White|CS|Chip Select|E.9||
|Purple|Int|Interupt|E.14||
