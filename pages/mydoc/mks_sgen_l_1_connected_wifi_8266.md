---
title: Connecting an MKS SGen L v1.0 via an ESP8266 WiFi Adapter
tags: []
keywords: 
last_updated: 15/07/2021
summary: "How to connect an MKS SGen L v1.0 via an ESP8266 WiFi Adapter"
sidebar: mydoc_sidebar
permalink: mks_sgen_l_1_connected_wifi_8266.html
folder: mydoc
comments: false
toc: false
datatable: true
...
The table below shows the pins required on the ESP8266 and what they are connected to on the MKS SGen L v1.0. Please ensure that your cables are no longer than 30cm although they should ideally be as short as possible.  

<div class="datatable-begin"></div>

| ESP8266 Pin       | MKS SGen Pin       | Resistor Value  |
| :-------------: |:-------------:| :---------------:|
