...
permalink: adapters_esp8266_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
There are now two versions of this board. The blue one is the original version and had 2 sets of EXP1 and EXP2 headers. The new version has a black PCB and passes 8 pins (10 pins including 5v and Gnd) through. This allows use of a 12864 display on an STM32 based board. Below is the pinout.  
...
Add the correct information for the board being used to the board.txt file. This can be found in the Updating the ESP8266 by RRF section on each connecting via WiFi page.  
</div>
