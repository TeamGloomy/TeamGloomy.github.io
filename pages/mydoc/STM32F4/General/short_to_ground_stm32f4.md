...
permalink: short_to_ground_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
5. Inspect the soldering of the driver socket.
6. Inspect the driver socket to see if there is anything that could be causing a poor connection with any of the pins.
7. This can happen if the driver is running in stealthChop mode and you are trying to move the motor too fast (this is a behaviour documented by Trinamic).
