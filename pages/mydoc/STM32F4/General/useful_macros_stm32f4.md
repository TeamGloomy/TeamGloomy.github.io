...
permalink: useful_macros_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
Essentially the only thing needed in your slicer end code is M0 to call stop.g.
...
A macro to enable the FYSETC Mini12864 V2.1 panel and fade up the display/set button colours.
