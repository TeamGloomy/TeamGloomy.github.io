...
permalink: firmware_limits_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
|MaxBedHeaters|4|The maximum number of bed heaters|
|MaxChamberHeaters|4|The maximum number of chamber heaters|
|MaxZProbes|8|The maximum number of probes|
|MaxGridProbePoints|441|The maximum number of mesh bed compensation points|
...
|MaxAxes|15|The maximum number of movement axes|
|MaxDriversPerAxis|4|The maximum number of stepper drivers assigned to one axis|
|MaxExtruders|14|The maximum number of extruders|
|MaxAxesPlusExtruders|15|The maximum number of axes + extruders|
|MaxHeatersPerTool|4|The maximum number of heaters per tool|
|MaxExtrudersPerTool|8|The maximum number of extruders per tool|
|MaxFans|32|The maximum number of fans|
|MaxTriggers|16|The maximum number of triggers|
