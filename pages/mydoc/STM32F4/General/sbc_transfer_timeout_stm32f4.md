...
permalink: sbc_transfer_timeout_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
1. Make sure you are running at least version 3.2.2 on both ends (especially on the rPi), this version has a fix that helps a lot with noise on the transfer ready line.
...
Another potential solution is to install a 0.47uF Y1 capacitor across the negative terminal of the power supply to the earth terminal of the power supply that connects to the mains ground. Also remove the negative supply from the Raspberry Pi power supply and attach the negative supply of the printer power supply to the Pi power supply at the terminals on the power supply. This got rid of the high resistance ground connection that connected the Pi to the SKR Pro experienced by @jimmaymaddness.
