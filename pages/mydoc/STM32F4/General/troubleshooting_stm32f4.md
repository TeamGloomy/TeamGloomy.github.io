...
permalink: troubleshooting_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
This can be checked by sending `M122 P200` in a USB terminal. Search for the lines `8266wifi.serialRxTxPins` and `serial.aux.rxTxPins` under the *Configurable Board.txt Settings* section.  
