...
permalink: interrupt_pins_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
Any STM32 pin is interrupt capable, **but** only one pin ending in a given number can be used as an interrupt source at a time (all pins sharing that number share the same interrupt line).  
