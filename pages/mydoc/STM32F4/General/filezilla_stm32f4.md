...
permalink: filezilla_stm32f4.html
folder: mydoc
comments: false
toc: false
---
...
6. Click on the `Transfer Settings` tab and tick the box to limit the number of simultaneous connections. Make sure it's set to 1.
