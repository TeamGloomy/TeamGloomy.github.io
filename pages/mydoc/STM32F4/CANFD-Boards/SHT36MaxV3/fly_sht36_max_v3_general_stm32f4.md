...
permalink: fly_sht36_max_v3_general_stm32f4.html
folder: mydoc
comments: false
toc: false
datatable: true
...
Download either the Stable firmware file called `Duet3Firmware_SHT36MAX3.uf2` from [here]({{site.latestStableFirmwareSTM32F4}}/expansion) or the latest beta/RC firmware file called `Duet3Firmware_SHT36MAX3.uf2` from [here]({{site.latestBetaFirmwareSTM32F4}}/expansion).
{% include warning.html content="The firmware version you choose to install should be the same version number as the mainboard you are connecting it to" %}
To install the firmware, whilst holding the reset button, plug the Fly-SHT36 Max V3 into your PC. Let go of the reset button and drag and drop the .uf2 file onto the rpi drive that appears.
Follow the [CAN Connection instructions](fly_sht36_max_v3_can_connection_stm32f4.html) to continue.  
