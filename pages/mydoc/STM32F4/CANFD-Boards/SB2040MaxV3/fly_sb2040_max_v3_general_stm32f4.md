...
permalink: fly_sb2040_max_v3_general_stm32f4.html
folder: mydoc
comments: false
toc: false
datatable: true
...
Download either the Stable firmware file called `Duet3Firmware_SB2040MAX3.uf2` from [here]({{site.latestStableFirmwareSTM32F4}}/expansion) or the latest beta/RC firmware file called `Duet3Firmware_SB2040MAX3.uf2` from [here]({{site.latestBetaFirmwareSTM32F4}}/expansion).
...
Follow the [CAN Connection instructions](fly_sb2040_max_v3_can_connection_stm32f4.html) to continue.  
