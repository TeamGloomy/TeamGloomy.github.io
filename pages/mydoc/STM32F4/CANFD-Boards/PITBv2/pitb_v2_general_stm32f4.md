---
title: Fysetc PITB V2.0 General Information
tags: []
keywords: 
last_updated: 06/03/2025
summary: "General information regarding the Fysetc PITB V2.0 Toolboard"
permalink: pitb_v2_general_stm32f4.html
folder: mydoc
comments: false
toc: false
datatable: true
...
This page covers any general information for the Fysetc PITB V2.0.  
...
The Fysetc PITB V2.0 is compatible with all Duet 3 boards and STM32H723, STM32H743 and STM32F4 boards with spican modules running 3.5.1 and above.  
...
The fan voltage can be set using jumpers to either 5v or 24v. See the [Fan instructions](pitb_v2_fans_stm32f4.html) for more information.

### CAN Termination

The CAN termination can't be removed from the Fysetc PITB V2.0.
...
{% include important.html content="Fysetc PITB V2.0 is only supported from release 3.5.1." %}
Download either the Stable firmware file called `Duet3Firmware_PITBV2_0.uf2` from [here]({{site.latestStableFirmwareSTM32F4}}/expansion) or the latest beta/RC firmware file called `Duet3Firmware_PITBV2_0.uf2` from [here]({{site.latestBetaFirmwareSTM32F4}}/expansion).
...
To install the firmware, whilst holding the BOOTSEL button, plug the Fysetc PITB V2.0 into your PC and drag and drop the .uf2 file onto the rpi drive that appears. Once uploaded, remove the toolboard from the computer.  
Follow the [CAN Connection instructions](pitb_v2_can_connection_stm32f4.html) to continue.  
