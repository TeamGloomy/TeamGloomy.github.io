---
title: Connecting Neopixels to a Fysetc PITB V2.0
tags: []
keywords: 
last_updated: 15/12/2024
summary: "How to connect Neopixels to a Fysetc PITB V2.0"
permalink: pitb_v2_neopixels_stm32f4.html
folder: mydoc
comments: false
toc: false
datatable: true
...
The Fysetc PITB V2.0 has support for connecting Neopixels using the header called "rgbled" (GPIO26).  

### Wiring

Neopixels can be wired to the Fysetc PITB V2.0 as shown on the pinout.  
