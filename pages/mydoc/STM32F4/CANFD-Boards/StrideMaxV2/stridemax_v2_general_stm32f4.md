...
This page covers any general information for the Fysetc StrideMax Dual V2.0.  
...
The Fysetc StrideMax Dual V2.0 is compatible with all Duet 3 boards and STM32H723, STM32H743 and STM32F4 boards with spican modules running 3.5 beta 4 and above.  
...
The fan voltage can be set using jumpers to either 5v or 12v. See the [Fan instructions](stridemax_v2_fans_stm32f4.html) for more information.
...
{% include important.html content="Fysetc StrideMax Dual V2.0 is only supported from release 3.5.0-RC2." %}
Download either the Stable firmware file called `Duet3Firmware_STRIDEMAXV2_0.uf2` from [here]({{site.latestStableFirmwareSTM32F4}}/expansion) or the latest beta/RC firmware file called `Duet3Firmware_STRIDEMAXV2_0.uf2` from [here]({{site.latestBetaFirmwareSTM32F4}}/expansion).
...
Follow the [CAN Connection instructions](stridemax_v2_can_connection_stm32f4.html) to continue.  
