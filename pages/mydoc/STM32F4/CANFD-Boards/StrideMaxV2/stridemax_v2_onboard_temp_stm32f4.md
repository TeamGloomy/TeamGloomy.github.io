---
title: Configuring the Fysetc StrideMax Dual V2.0 onboard temperature sensor
tags: []
keywords: 
last_updated: 27/12/2023
summary: "How to configure the Fysetc StrideMax Dual V2.0 onboard temperature sensor"
permalink: stridemax_v2_onboard_temp_stm32f4.html
folder: mydoc
comments: false
toc: false
datatable: true
...
The Fysetc StrideMax Dual V2.0 has two temperature sensors on the PCB, that can be used to monitor the driver temperature.
...
{% include image.html file="fysetc_stridemax_temp.png" url="https://teamgloomy.github.io/images/fysetc_stridemax_temp.png" alt="Fysetc StrideMax Dual V2.0 Onboard Temperature Sensor" caption="Fysetc StrideMax Dual V2.0 Onboard Temperature Sensor" %}
