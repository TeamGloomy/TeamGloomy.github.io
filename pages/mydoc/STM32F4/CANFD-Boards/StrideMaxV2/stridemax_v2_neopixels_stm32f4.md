---
title: Connecting Neopixels to a Fysetc StrideMax Dual V2.0
tags: []
keywords: 
last_updated: 27/12/2023
summary: "How to connect Neopixels to a Fysetc StrideMax Dual V2.0"
permalink: stridemax_v2_neopixels_stm32f4.html
folder: mydoc
comments: false
toc: false
datatable: true
...
The Fysetc StrideMax Dual V2.0 has support for connecting Neopixels using the header called "rgbled" (GPIO26).  

### Wiring

Neopixels can be wired to the Fysetc StrideMax Dual V2.0 as shown on the pinout.  
