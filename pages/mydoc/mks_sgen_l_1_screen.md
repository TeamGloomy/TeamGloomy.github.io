---
title: Connecting a screen to an MKS SGen L v1.0
tags: []
keywords: 
last_updated: 15/07/2021
summary: "How to connect a serial screen to an MKS SGen L v1.0"
sidebar: mydoc_sidebar
permalink: mks_sgen_l_1_screen.html
folder: mydoc
comments: false
toc: false
datatable: true
...
Only screens that use a serial connection can be connected to the MKS SGen L v1.0
