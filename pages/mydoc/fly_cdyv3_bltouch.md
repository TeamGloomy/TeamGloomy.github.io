...
Connect the BLTouch to the Fly-CDYv3 as described in the table below.  

<div class="datatable-begin"></div>

|BLTouch Wire Colour|Fly-CDYv3 Pin|Fly-CDYv3 Pin Name|
|:---|:---|:---|
|Brown|GND||
|Red|5v||
|Yellow|E.6|Servo0|
...
M950 S0 C"servo0"                              ; Setup servo 0 as servo port on Fly-CDYv3
```
